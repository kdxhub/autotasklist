...
const /*文章授权协议*/conf_licen=`AGPL-3`;
const /*文章授权协议链接*/conf_licen_link=`https://github.com/kdxhub/autotasklist/blob/master/LICENSE`;
...
const /*左侧边栏·一言*/conf_saying=`让体验变得更好。`;
...
<s-chip id="side_ship_0" onclick="openURL('/autotasklist/','')" clickable="true" class="sidebar_btn">
<s-icon slot="start" type="home"></s-icon>
主页</s-chip>
<s-chip id="side_ship_1" onclick="openURL('/autotasklist/about_at','')" clickable="true" class="sidebar_btn">
<s-icon slot="start" type="home"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
  <path d="M440-280h80v-200h-80v200Zm40-280q17 0 28.5-11.5T520-600q0-17-11.5-28.5T480-640q-17 0-28.5 11.5T440-600q0 17 11.5 28.5T480-560ZM160-120v-480l320-240 320 240v480H160Zm80-80h480v-360L480-740 240-560v360Zm240-270Z"></path>
</svg></s-icon>
关于「自动任务App」</s-chip>
<s-chip id="side_ship_2" onclick="openURL('/autotasklist/aboit_import','')" clickable="true" class="sidebar_btn">
<s-icon slot="start" type="home"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
...
const   /*阻止一些简易解除复制限制脚本工作并提示用户*/conf_prenevtOnclickOverwrite=false;
